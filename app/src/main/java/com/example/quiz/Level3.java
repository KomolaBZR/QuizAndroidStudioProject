...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level3); //set text
      ...
      //  background.setImageResource(R.drawable.level3);
        ...
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));// backgroung of the dialog box is transparent
        ...
        dialogEnd.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));// backgroung of the dialog box is transparent
        ...
        btnclose2.setOnClickListener(v -> {
            ...
            dialogEnd.dismiss(); // close dialog box
        });
        ...
        btncontinue2.setOnClickListener(v -> {
            try{
                Intent intent = new Intent(Level3.this, Level4.class);//muss correct!!!!!
                startActivity(intent);
                finish();
            }catch(Exception e){
                e.printStackTrace();
        ...
        numLeft = random.nextInt(21); //generating a random number
        img_left.setImageResource(array.images3[numLeft]); //getting the image from the array
        text_left.setText(array.texts3[numLeft]); //getting the text from the array

        numRight = random.nextInt(21); //generating a random number
        ...
        img_right.setImageResource(array.images3[numRight]); //getting the image from the array
        text_right.setText(array.texts3[numRight]); //getting the text from the array
