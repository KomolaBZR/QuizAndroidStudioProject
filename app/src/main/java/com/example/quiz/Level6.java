...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level6); //set text
        ...
        img_left.setImageResource(array.images6[numLeft]);      // getting the image from the array
        text_left.setText(array.texts6[numLeft]);       //getting the text from the array
        ...
        img_right.setImageResource(array.images6[numRight]);        //getting the image from the array
        text_right.setText(array.texts6[numRight]);         //getting the text from the array
