...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level1); //set text
        ...
        img_left.setImageResource(array.images1[numLeft]);      // getting the image from the array
        text_left.setText(array.texts1[numLeft]);       //getting the text from the array
        ...
        img_right.setImageResource(array.images1[numRight]);        //getting the image from the array
        text_right.setText(array.texts1[numRight]);         //getting the text from the array
