...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level4); //set text
      ...
      //  background.setImageResource(R.drawable.level3);
        ...
        btncontinue2.setOnClickListener(v -> {
            try{
                Intent intent = new Intent(Level4.this, Level5.class);//muss correct!!!!!
                startActivity(intent);
                finish();
            }catch(Exception e){
                e.printStackTrace();
        ...
        numLeft = random.nextInt(20); //generating a random number
        img_left.setImageResource(array.images4[numLeft]); //getting the image from the array
        text_left.setText(array.texts4[numLeft]); //getting the text from the array

        numRight = random.nextInt(20); //generating a random number
        ...
        img_right.setImageResource(array.images4[numRight]); //getting the image from the array
        text_right.setText(array.texts4[numRight]); //getting the text from the array
