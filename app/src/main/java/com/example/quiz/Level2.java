...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level2); //set text
        ...
        img_left.setImageResource(array.images2[numLeft]); //getting the image from the array
        text_left.setText(array.texts2[numLeft]); //getting the text from the array
        ...
        img_right.setImageResource(array.images2[numRight]); //getting the image from the array
        text_right.setText(array.texts2[numRight]); //getting the text from the array
